...
{   
    public partial class XIVCalcForm : Form
    {
        ...
        private readonly string HELP_MESSAGE = @"Purpose: Using stat weights discovered through testing, this calculator translates secondary stat values into a total primary stat value. For example, if Determination was discovered to be worth .25 STR for DRG, 4 determination would equal 1 STR." + Environment.NewLine +
                 ...
                 "Skill speed: The spell/skill speed stat." + Environment.NewLine +
